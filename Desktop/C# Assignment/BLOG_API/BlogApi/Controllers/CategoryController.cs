...
namespace BlogApi.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public IActionResult GetById(int id)
        {
            ...
            DomainLayer.Models.TemsBlogModels.Category? category = _unitOfWork.categoryService.GetCategory(id);
        ...
        public IActionResult CreateCategory([FromBody] CategoryZDto category)
        {
            ...
            DomainLayer.Models.TemsBlogModels.Category mappedCategory = _categoryZMapper.MapCategoryDtoToCategory(category);


            DomainLayer.Models.TemsBlogModels.Category? createdCategory = _unitOfWork.categoryService.CreateCategory(mappedCategory, out string message);
        ...
        public IActionResult UpdateCategory([FromBody] CategoryZDto category)
        {
            ...
            DomainLayer.Models.TemsBlogModels.Category? categoryUpdated = _unitOfWork.categoryService.UpdateCategory(mappedCategory, out string message);
        ...
        public IActionResult DeleteCategory([FromBody] DeleteRequestCategoryZDto category)
        {
            ...
            DomainLayer.Models.TemsBlogModels.Category mappedCategory = _categoryZMapper.MapDeleteCategoryZRequestToCategoryZ(category);
